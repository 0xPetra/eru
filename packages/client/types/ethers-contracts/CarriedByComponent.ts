...
export interface CarriedByComponentInterface extends utils.Interface {
  contractName: "CarriedByComponent";
  functions: {
...
export interface CarriedByComponent extends BaseContract {
  contractName: "CarriedByComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CarriedByComponentInterface;
