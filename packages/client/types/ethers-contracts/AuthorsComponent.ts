...
export interface AuthorsComponentInterface extends utils.Interface {
  contractName: "AuthorsComponent";
  functions: {
...
export interface AuthorsComponent extends BaseContract {
  contractName: "AuthorsComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuthorsComponentInterface;
