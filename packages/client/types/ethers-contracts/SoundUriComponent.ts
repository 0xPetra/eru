...
export interface SoundUriComponentInterface extends utils.Interface {
  contractName: "SoundUriComponent";
  functions: {
...
export interface SoundUriComponent extends BaseContract {
  contractName: "SoundUriComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SoundUriComponentInterface;
