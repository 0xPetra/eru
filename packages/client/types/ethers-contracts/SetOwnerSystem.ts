...
export interface SetOwnerSystemInterface extends utils.Interface {
  contractName: "SetOwnerSystem";
  functions: {
...
export interface SetOwnerSystem extends BaseContract {
  contractName: "SetOwnerSystem";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SetOwnerSystemInterface;
