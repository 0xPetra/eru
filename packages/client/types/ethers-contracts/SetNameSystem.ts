...
export interface SetNameSystemInterface extends utils.Interface {
  contractName: "SetNameSystem";
  functions: {
...
export interface SetNameSystem extends BaseContract {
  contractName: "SetNameSystem";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SetNameSystemInterface;
